...
<body>
    ...
    <nav class="navbar">
      ...
      <ul class="nav-links" id="nav-links">
        ...
        <li><a href="page d'avis.php">Avis et commentaires</a></li>
        <li class="social">
    ...
    <section class="hero">
        <div class="header">
            <h1>🏆 Créez une nouvelle tâche</h1><br>
            <p class="subtitle">Gagnez du temps, publiez votre tâche et laissez un technicien vous aidez.</p>
        </div>
    </section>
